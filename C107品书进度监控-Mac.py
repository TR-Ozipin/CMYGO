...
# ========== 用户可修改配置 ==========
# 数据库文件路径
database_path = r"/Users/jin/Documents/插画师数据库 - 主表.csv"
# 存放 Comike_Info_*.csv 的目录
comike_info_dir = r"/Users/jin/Downloads"
# 品书主文件夹路径（脚本递归遍历该目录及子目录中的 jpg/png 文件）
shinagaki_dir = r"/Users/jin/Library/CloudStorage/OneDrive-个人/C107品书"
# 输出 HTML 文件的路径
output_dir = r"/Users/jin/Downloads/暂无品书列表"
